  ...
  return (
    ...
    >
      ...
      <div className="relative h-full p-5 flex flex-col">
        ...
        {/* Location */}
        <div className="flex items-center gap-1.5 text-purple-200/40 text-xs">
        ...
        {/* Swipe hints */}
        {isTop && (
          <div className="absolute bottom-3 left-0 right-0 flex justify-center gap-8 text-[10px] text-purple-300/30">
            <span>← Skip</span>
            <span>Accept →</span>
          </div>
        )}
